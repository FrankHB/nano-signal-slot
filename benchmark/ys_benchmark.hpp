...
class Ys : public Nano::Observer
{
    ...
    using Subject = YSLib::GEvent<void(Rng_t&)>;
    using Foo = Benchmark::Ys;
...
chrono_timer Ys::timer;

} // namespace Benchmark -------------------------------------------------------

#endif // Ys_BENCHMARK_HPP
